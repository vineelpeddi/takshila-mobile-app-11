...
public class PlayerActivity extends AppCompatActivity implements VdoPlayer.InitializationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerFragment = (VdoPlayerFragment)getFragmentManager().findFragmentById(R.id.vdo_player_fragment);
       ...
       // setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_SENSOR_PORTRAIT);
        ...
        whatsapp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String contact = "+91 9971994728"; // use country code with your phone number
    ...
    private void obtainOtpAndPlaybackInfo() {
        ...
        new Thread(() -> {
            try {
                ...
                Pair<String, String> pair = Utils.getSampleOtpAndPlaybackInfo(queue1);
